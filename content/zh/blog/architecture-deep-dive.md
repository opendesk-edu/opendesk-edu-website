...
在此基础之上，openDesk Edu 新增了一系列面向教育的专用服务：ILIAS、Moodle、BigBlueButton、OpenCloud、Etherpad、CryptPad、BookStack、Planka、Zammad、LimeSurvey、LTB SSP、Draw.io、Excalidraw 和 TYPO3。所有服务共享同一套身份验证、网络和存储基础设施。
