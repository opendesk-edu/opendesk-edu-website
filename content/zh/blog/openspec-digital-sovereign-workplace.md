...
**openDesk Edu 的 OpenSpec** 是 OpenSpec 框架应用于真实数字工作场所的最完整示例。它规定了 一套完整的集成开源服务，为教育机构提供服务。

### 范围：服务套件，58 个规范

OpenSpec 涵盖：

**服务规范**：每个集成服务一个（Nextcloud、Moodle、Keycloak 等）
...
使用 Ralph Loop 方法，我们在套件中的所有服务上实现了 **100% 合规**：
